...
(512,64)->conv(512,9,2)->(512,32)           |           |           |           |
 (512,32)->(512x2,9)->(1024,32)-sp->(512,64)+=(1024,64) |           |           |
  (1024,64)->(512x2,17)->(1024,64)-sp->(512,128)        +=(1024,64) |           |
    (1024,128)->conv(256x2,33)->(1024,64)-sp->(256,256)             +=(512,256) |
      (512,256)->conv(128x2,63)->(256,256)-sp->(128.512)                        +=(256,512)
